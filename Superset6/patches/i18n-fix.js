        ...
        for (const original of stringsToTranslate) {
            ...
            if (translated && translated !== original) {
                ...
                const patterns = [
                    ...
                    // Drop zone and button text patterns
                    new RegExp(`children:\\s*["']${escapeRegex(original)}["']`, 'g'),
                    new RegExp(`text:\\s*["']${escapeRegex(original)}["']`, 'g'),
                    new RegExp(`>\\s*${escapeRegex(original)}\\s*<`, 'g'),
                    // Template literal and string concatenation patterns
